...
class InverterMsg(object):
    ...
    def __init__(self, msg):
        self.raw_msg = msg
        self.headCode = self.__get_int(0)
        if (self.headCode == 165): # V5 = 0xa5
            self.Frame_offset = 11 # initialBytesToStrip
            self.iData_offset = 32 # inverterDataAdjustment
        else: # V4 = 0x68
            self.Frame_offset = 12 # initialBytesToStrip
            self.iData_offset = 15 # inverterDataAdjustment
...
#
    def __get_short(self, begin, divider=10):
        ...
        Returns:
            signed float: Value stored at location `begin`
        """
    ...
    def __get_long(self, begin, divider=10):
        ...
        Returns:
            float: Value stored at location `begin`
        """
        return float(
    ...
    def msg(self):
        """received status msg."""
        return self.__get_string(self.Frame_offset + 0, self.len + self.Frame_offset + 0)

    @property
    def id(self):
        """ID of the inverter."""
        return self.__get_string(self.iData_offset + 0, self.iData_offset + 16).rstrip() #Strip spaces from shorter inverter SN

    @property
    def temperature(self):
        """Temperature recorded by the inverter."""
        return self.__get_short(self.iData_offset + 16)

    @property
    def power(self):
        """Power output"""
        return self.__get_short(self.iData_offset + 44)

    @property
    def e_today(self):
        """Energy generated by inverter today in kWh"""
        return self.__get_short(self.iData_offset + 54, 100)  # Divide by 100

    @property
    def e_total(self):
        """Total energy generated by inverter in kWh"""
        return self.__get_long(self.iData_offset + 56)

    @property
    def h_total(self):
        """Hours the inverter generated electricity"""
        return int(self.__get_long(self.iData_offset + 60, 1))  # Don't divide

    @property
    def run_state(self):
        """RUN State"""
        return int(self.__get_short(self.iData_offset + 64, 1))

    @property
    def GVFaultValue(self):
        """Grid voltage fault value in V"""
        return self.__get_short(self.iData_offset + 66, 10)  # Divide by 10

    @property
    def GVFaultValue(self):
        """Grid frequency fault value in Hz"""
        return self.__get_short(self.iData_offset + 68, 100)  # Divide by 100

    @property
    def GZFaultValue(self):
        """Grid impedance fault value in Ohm"""
        return self.__get_short(self.iData_offset + 70, 1000)  # Divide by 1000

    @property
    def TmpFaultValue(self):
        """Temperature fault value in oC"""
        return self.__get_short(self.iData_offset + 72, 10)  # Divide by 10

    @property
    def PVFaultValue(self):
        """PV voltage fault value in V"""
        return self.__get_short(self.iData_offset + 74, 10)  # Divide by 10

    @property
    def GFCIFaultValue(self):
        """GFCI current fault value in A"""
        return self.__get_short(self.iData_offset + 76, 1000)  # Divide by 1000

    @property
    def errorMsg(self):
        """errorMsg binary index value"""
        return int(self.__get_long(self.iData_offset + 78))

    @property
    def main_fwver(self):
        """Inverter main firmware version."""
        if (self.__get_int(self.iData_offset + 86) == 0): return ""
        return re.sub('[^\x20-\x7f]', '', self.__get_string(self.iData_offset + 86, 120))

    @property
    def slave_fwver(self):
        """Inverter slave firmware version."""
        if (self.__get_int(self.iData_offset + 106) == 0): return ""
        return re.sub('[^\x20-\x7f]', '', self.__get_string(self.iData_offset + 106, 140))
    ...
    def v_pv(self, i=1):
        ...
        if i not in range(1, 4):
            i = 1
        num = (self.iData_offset + 18) + (i - 1) * 2
    ...
    def i_pv(self, i=1):
        ...
        if i not in range(1, 4):
            i = 1
        num = (self.iData_offset + 24) + (i - 1) * 2
        return self.__get_short(num)
    ...
    def i_ac(self, i=1):
        ...
        if i not in range(1, 4):
            i = 1
        num = (self.iData_offset + 30) + (i - 1) * 2
        return self.__get_short(num)
    ...
    def v_ac(self, i=1):
        ...
        if i not in range(1, 4):
            i = 1
        num = (self.iData_offset + 36) + (i - 1) * 2
        return self.__get_short(num)
    ...
    def f_ac(self, i=1):
        ...
        if i not in range(1, 4):
            i = 1
        num = (self.iData_offset + 42) + (i - 1) * 4
    ...
    def p_ac(self, i=1):
        ...
        if i not in range(1, 4):
            i = 1
        num = (self.iData_offset + 44) + (i - 1) * 4
