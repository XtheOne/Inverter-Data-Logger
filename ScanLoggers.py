...
try:
    ...
    sent = sock.sendto(LPB_FIRST_COMMAND.encode('utf-8'), ('<broadcast>', 48899))
    ...
    while True:
        try:
            ...
            if (LPB_FIRST_COMMAND.encode('utf-8') in data or A11_FIRST_COMMAND.encode('utf-8') in data): continue #skip sent data
            a = data.split(b',')
